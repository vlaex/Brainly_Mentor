export default {
  ...
  "subjects": [{"id":2,"name":"Mathematics"},{"id":5,"name":"History"},{"id":1,"name":"English"},{"id":8,"name":"Biology"},{"id":18,"name":"Chemistry"},{"id":15,"name":"Physics"},{"id":3,"name":"Social Studies"},{"id":31,"name":"Advanced Placement (AP)"},{"id":32,"name":"SAT"},{"id":7,"name":"Geography"},{"id":6,"name":"Health"},{"id":21,"name":"Arts"},{"id":4,"name":"Business"},{"id":19,"name":"Computers and Technology"},{"id":29,"name":"French"},{"id":30,"name":"German"},{"id":28,"name":"Spanish"},{"id":22,"name":"World Languages"},{"id":33,"name":"Medicine"},{"id":34,"name":"Law"},{"id":35,"name":"Engineering"}]
};